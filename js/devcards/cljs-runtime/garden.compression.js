 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__47258){
var vec__47259 = p__47258;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47259,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47259,(1),null);
return (function (s){
...
var G__47316 = (i__4790__auto___47314 + (1));
i__4790__auto___47314 = G__47316;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__47264_SHARP_){
return (p1__47264_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__47264_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__47264_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq47267){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47267));
}));
...
var map__47298 = temp__5733__auto__;
var map__47298__$1 = (((((!((map__47298 == null))))?(((((map__47298.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47298.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47298):map__47298);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47298__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47298__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47298__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__47328 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__47329 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__47308 = tag;
var G__47308__$1 = (((G__47308 instanceof cljs.core.Keyword))?G__47308.fqn:null);
switch (G__47308__$1) {
case "string":
return chunk;
