 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__52486){
var vec__52487 = p__52486;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52487,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52487,(1),null);
return (function (s){
...
var len__4789__auto___52496 = arguments.length;
var i__4790__auto___52497 = (0);
while(true){
if((i__4790__auto___52497 < len__4789__auto___52496)){
args__4795__auto__.push((arguments[i__4790__auto___52497]));

var G__52498 = (i__4790__auto___52497 + (1));
i__4790__auto___52497 = G__52498;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__52490_SHARP_){
return (p1__52490_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52490_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__52490_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq52491){
...
var map__52492 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52492__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52492__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52492__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__52499 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__52500 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__52495 = tag;
