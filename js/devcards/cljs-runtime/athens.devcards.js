...
var map__80154 = bmi_data;
var map__80154__$1 = (((((!((map__80154 == null))))?(((((map__80154.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80154.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80154):map__80154);
var data = map__80154__$1;
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80154__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var weight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80154__$1,new cljs.core.Keyword(null,"weight","weight",-1262796205));
var bmi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80154__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var h = (height / (100));
if((bmi == null)){
...
var map__80160 = athens.devcards.calc_bmi(cljs.core.deref(bmi_data));
...
var weight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80160__$1,new cljs.core.Keyword(null,"weight","weight",-1262796205));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80160__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var bmi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80160__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var vec__80161 = (((bmi < 18.5))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["orange","underweight"], null):(((bmi < (25)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["inherit","normal"], null):(((bmi < (30)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["orange","overweight"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["red","obese"], null)
)));
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80161,(0),null);
var diagnose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80161,(1),null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.t_athens$devcards80170 !== 'undefined')){
} else {
...
*/
athens.devcards.t_athens$devcards80170 = (function (meta80171){
this.meta80171 = meta80171;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.t_athens$devcards80170.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_80172,meta80171__$1){
var self__ = this;
var _80172__$1 = this;
return (new athens.devcards.t_athens$devcards80170(meta80171__$1));
}));

(athens.devcards.t_athens$devcards80170.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_80172){
var self__ = this;
var _80172__$1 = this;
return self__.meta80171;
}));

(athens.devcards.t_athens$devcards80170.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.t_athens$devcards80170.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47392__auto__,devcard_opts__47393__auto__){
var self__ = this;
var this__47392__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__47393__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__47411__auto__ = athens.devcards.bmi_component;
...
(athens.devcards.t_athens$devcards80170.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta80171","meta80171",-358228005,null)], null);
}));

(athens.devcards.t_athens$devcards80170.cljs$lang$type = true);

(athens.devcards.t_athens$devcards80170.cljs$lang$ctorStr = "athens.devcards/t_athens$devcards80170");

(athens.devcards.t_athens$devcards80170.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards/t_athens$devcards80170");
}));

/**
 * Positional factory function for athens.devcards/t_athens$devcards80170.
 */
athens.devcards.__GT_t_athens$devcards80170 = (function athens$devcards$__GT_t_athens$devcards80170(meta80171){
return (new athens.devcards.t_athens$devcards80170(meta80171));
});

}

return (new athens.devcards.t_athens$devcards80170(null));
})()
