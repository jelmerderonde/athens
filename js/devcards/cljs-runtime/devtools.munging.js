...
var o42560 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42560["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42561 = temp__5733__auto____$1;
return (o42561["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40213__auto__ = f;
return (o__40213__auto__["toString"]).call(o__40213__auto__);
} else {
return "";
}
}catch (e42562){var _ = e42562;
return "";
}});
...
try{var o__40213__auto___42788 = t;
(o__40213__auto___42788["cljs$lang$ctorPrWriter"]).call(o__40213__auto___42788,t,writer);
}catch (e42563){var __42789 = e42563;
}
...
var char_code = (function (){var o__40213__auto__ = (new String(char$));
return (o__40213__auto__["charCodeAt"]).call(o__40213__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40213__auto__ = String;
return (o__40213__auto__["fromCharCode"]).call(o__40213__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42565 = num_code;
switch (G__42565) {
case (1):
return (185);
...
var o__40213__auto__ = String;
return (o__40213__auto__["fromCharCode"]).call(o__40213__auto__,superscript_code);
});
/**
...
}catch (e42567){var _e__40220__auto__ = e42567;
return false;
}})())){
...
var vec__42568 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42568,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42573 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42573["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42574 = temp__5733__auto____$1;
return (o42574["nameToPath"]);
} else {
return null;
}
} else {
...
var G__42799 = (i__4790__auto___42797 + (1));
i__4790__auto___42797 = G__42799;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42594){
var vec__42595 = p__42594;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42595,(0),null);
...
var G__42803 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42804 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42803;
remaining_tokens = G__42804;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42575){
var G__42576 = cljs.core.first(seq42575);
var seq42575__$1 = cljs.core.next(seq42575);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42576,seq42575__$1);
}));
...
var vec__42626 = cljs.core.split_with((function (p1__42625_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42625_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42626,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42626,(1),null);
...
var vec__42636 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42636,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42636,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42827 = cljs.core.rest(remaining_tokens);
var G__42828 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42827;
name_tokens = G__42828;
continue;
} else {
...
var vec__42649 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42649,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42649,(1),null);
var vec__42652 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42652,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42652,(1),null);
var vec__42655 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42655,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42655,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42655,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42655,(3),null);
...
var vec__42660 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42660,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42660,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42660,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42660,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42660,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42660,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42665 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42665,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42665,(1),null);
var vec__42669 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42669,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42669,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42674 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42674) : devtools.munging.parse_fn_info_deep.call(null,G__42674));
})()));
}
} else {
return fn_info;
...
var G__42832 = (arity + (1));
var G__42833 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42687){
var vec__42688 = p__42687;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42688,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42688,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42714_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42714_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42715_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42715_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___42843 = arguments.length;
var i__4790__auto___42844 = (0);
while(true){
if((i__4790__auto___42844 < len__4789__auto___42843)){
args__4795__auto__.push((arguments[i__4790__auto___42844]));

var G__42845 = (i__4790__auto___42844 + (1));
i__4790__auto___42844 = G__42845;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42719){
var vec__42720 = p__42719;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42720,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42717){
var G__42718 = cljs.core.first(seq42717);
var seq42717__$1 = cljs.core.next(seq42717);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42718,seq42717__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42739__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42739__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42739__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42739__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42740 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42740,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42740,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42740,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42740,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42740,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42740,(5),null);
...
var o__40213__auto__ = f;
return (o__40213__auto__["getBasis"]).call(o__40213__auto__);
});
/**
...
}catch (e42750){var _e__40220__auto__ = e42750;
...
var G__42862 = (obj[cljs.core.first(path)]);
var G__42863 = cljs.core.rest(path);
obj = G__42862;
path = G__42863;
continue;
} else {
...
var _STAR_ = (function (accum,p__42770){
var vec__42771 = p__42770;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42771,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42771,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42779){
var vec__42780 = p__42779;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42780,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42780,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42780,(2),null);
...
var post_process = (function (p__42784){
var vec__42785 = p__42784;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42785,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42785,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42783_SHARP_){
return (obj[cljs.core.first(p1__42783_SHARP_)]);
}),sorted_matches);
