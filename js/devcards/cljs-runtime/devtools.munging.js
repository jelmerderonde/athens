...
var o40857 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40857["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40858 = temp__5733__auto____$1;
return (o40858["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40471__auto__ = f;
return (o__40471__auto__["toString"]).call(o__40471__auto__);
} else {
return "";
}
}catch (e40859){var _ = e40859;
return "";
}});
...
try{var o__40471__auto___41087 = t;
(o__40471__auto___41087["cljs$lang$ctorPrWriter"]).call(o__40471__auto___41087,t,writer);
}catch (e40873){var __41092 = e40873;
}
...
var char_code = (function (){var o__40471__auto__ = (new String(char$));
return (o__40471__auto__["charCodeAt"]).call(o__40471__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40471__auto__ = String;
return (o__40471__auto__["fromCharCode"]).call(o__40471__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40881 = num_code;
switch (G__40881) {
case (1):
return (185);
...
var o__40471__auto__ = String;
return (o__40471__auto__["fromCharCode"]).call(o__40471__auto__,superscript_code);
});
/**
...
}catch (e40889){var _e__40504__auto__ = e40889;
return false;
}})())){
...
var vec__40890 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40890,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o40908 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40908["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40909 = temp__5733__auto____$1;
return (o40909["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40912){
var vec__40914 = p__40912;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40914,(0),null);
...
var G__41116 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41117 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41116;
remaining_tokens = G__41117;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40910){
...
var vec__40932 = cljs.core.split_with((function (p1__40929_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40929_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40932,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40932,(1),null);
...
var vec__40949 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40949,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40949,(1),null);
var vec__40952 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40952,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40952,(1),null);
var vec__40955 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40955,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40955,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40955,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40955,(3),null);
...
var vec__40961 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40961,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40961,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40961,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40961,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40961,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40961,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__40975 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40975,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40975,(1),null);
var vec__40978 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40978,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40978,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__40983 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__40983) : devtools.munging.parse_fn_info_deep.call(null,G__40983));
})()));
}
} else {
return fn_info;
...
var G__41172 = (arity + (1));
var G__41173 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40992){
var vec__40994 = p__40992;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40994,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40994,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41001_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41001_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41002_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41002_SHARP_);
}),sorted_infos);
...
var G__41178 = (i__4790__auto___41177 + (1));
i__4790__auto___41177 = G__41178;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41010){
var vec__41011 = p__41010;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41003){
...
var o__40471__auto__ = f;
return (o__40471__auto__["getBasis"]).call(o__40471__auto__);
});
/**
...
}catch (e41038){var _e__40504__auto__ = e41038;
...
var G__41215 = (obj[cljs.core.first(path)]);
var G__41216 = cljs.core.rest(path);
obj = G__41215;
path = G__41216;
continue;
} else {
...
var _STAR_ = (function (accum,p__41055){
var vec__41056 = p__41055;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41056,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41056,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41062){
var vec__41063 = p__41062;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41063,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41063,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41063,(2),null);
...
var post_process = (function (p__41076){
var vec__41077 = p__41076;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41077,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41077,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41070_SHARP_){
return (obj[cljs.core.first(p1__41070_SHARP_)]);
}),sorted_matches);
