...
var G__52372_52411 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__52373_52412 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__52372_52411,G__52373_52412) : re_frame.core.reg_sub.call(null,G__52372_52411,G__52373_52412));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__52378){
...
var ___$1 = first__52381;
var route = seq__52380__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__52383,p__52384){
var map__52385 = p__52383;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52385__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52386 = p__52384;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52386,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52386,(1),null);
...
var node = (function (){var G__52390 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"node","node",581201198),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__52390) : re_frame.core.subscribe.call(null,G__52390));
})();
...
var G__52391_52418 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__52392_52419 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
var result__48702__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__48701__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__48702__auto__ = reitit.frontend.easy.push_state;
...
var result__48702__auto__ = route;
...
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__52391_52418,G__52392_52419) : re_frame.core.reg_fx.call(null,G__52391_52418,G__52392_52419));
...
var G__52400 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52400) : re_frame.core.dispatch.call(null,G__52400));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__52401 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52401) : re_frame.core.dispatch.call(null,G__52401));
});
athens.router.navigate_page = (function athens$router$navigate_page(uid){
var G__52405 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52405) : re_frame.core.dispatch.call(null,G__52405));
});
athens.router.toggle_open = (function athens$router$toggle_open(dbid,open){
var G__52410 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","toggle-open","block/toggle-open",2080151710),dbid,open], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52410) : re_frame.core.dispatch.call(null,G__52410));
});
