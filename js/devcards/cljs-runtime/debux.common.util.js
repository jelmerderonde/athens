...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48119_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__48119_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48118_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48118_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48120_SHARP_){
return (((p1__48120_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__48120_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__48125,mapping){
var map__48127 = p__48125;
...
var state = map__48127__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48127__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48127__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48127__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48123_SHARP_){
if((p1__48123_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__48123_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__48172 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__48173 = clojure.zip.next(loc);
loc = G__48173;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__48135){
var vec__48136 = p__48135;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48136,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq48133){
var G__48134 = cljs.core.first(seq48133);
var seq48133__$1 = cljs.core.next(seq48133);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48134,seq48133__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48139_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48139_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__48141_48199 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__48142_48200 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__48143_48201 = true;
var _STAR_print_fn_STAR__temp_val__48144_48202 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__48143_48201);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__48144_48202);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__48142_48200);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__48141_48199);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48140_SHARP_){
return debux.common.util.prepend_bars(p1__48140_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__48203 = cljs.core.next(opts__$1);
var G__48204 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__48203;
acc = G__48204;
continue;
} else {
...
var G__48206 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__48205;
acc = G__48206;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__48207 = cljs.core.nnext(opts__$1);
var G__48208 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__48207;
acc = G__48208;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__48209 = cljs.core.next(opts__$1);
var G__48210 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__48209;
acc = G__48210;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48147 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__48147.cljs$core$IFn$_invoke$arity$1 ? fexpr__48147.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48147.call(null,f));
})())){
var G__48212 = cljs.core.next(opts__$1);
var G__48213 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__48212;
acc = G__48213;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48148 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__48148.cljs$core$IFn$_invoke$arity$1 ? fexpr__48148.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48148.call(null,f));
})())){
var G__48215 = cljs.core.nnext(opts__$1);
var G__48216 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__48215;
acc = G__48216;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__48217 = cljs.core.next(opts__$1);
var G__48218 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__48217;
acc = G__48218;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__48149){
...
var G__48155 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__48154 = (function (){var fexpr__48156 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__48156.cljs$core$IFn$_invoke$arity$1 ? fexpr__48156.cljs$core$IFn$_invoke$arity$1(form) : fexpr__48156.call(null,form));
})();
return (fexpr__48154.cljs$core$IFn$_invoke$arity$1 ? fexpr__48154.cljs$core$IFn$_invoke$arity$1(G__48155) : fexpr__48154.call(null,G__48155));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48158 = quoted_form;
var G__48159 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48158,G__48159) : debux.common.util.remove_d.call(null,G__48158,G__48159));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48160 = quoted_form;
var G__48161 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48160,G__48161) : debux.common.util.remove_d.call(null,G__48160,G__48161));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__48225__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48162 = quoted_form;
var G__48163 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48162,G__48163) : debux.common.util.remove_d.call(null,G__48162,G__48163));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__48225 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__48230__i = 0, G__48230__a = new Array(arguments.length -  0);
while (G__48230__i < G__48230__a.length) {G__48230__a[G__48230__i] = arguments[G__48230__i + 0]; ++G__48230__i;}
  arg = new cljs.core.IndexedSeq(G__48230__a,0,null);
} 
return G__48225__delegate.call(this,arg);};
G__48225.cljs$lang$maxFixedArity = 0;
G__48225.cljs$lang$applyTo = (function (arglist__48231){
var arg = cljs.core.seq(arglist__48231);
return G__48225__delegate(arg);
});
...
var G__48236 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__48236;
continue;
} else {
...
var G__48237 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48237;
continue;
} else {
var G__48238 = clojure.zip.next(loc);
loc = G__48238;
continue;
