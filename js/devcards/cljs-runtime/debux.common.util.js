...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50023_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50023_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50022_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50022_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50024_SHARP_){
return (((p1__50024_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50024_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50038,mapping){
...
var state = map__50039__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50036_SHARP_){
if((p1__50036_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50036_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50119 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50123 = clojure.zip.next(loc);
loc = G__50123;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50068){
var vec__50069 = p__50068;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50069,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50064){
var G__50065 = cljs.core.first(seq50064);
var seq50064__$1 = cljs.core.next(seq50064);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50065,seq50064__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50072_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50072_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50078_50136 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50079_50137 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50080_50138 = true;
var _STAR_print_fn_STAR__temp_val__50081_50139 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50080_50138);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50081_50139);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50079_50137);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50078_50136);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50074_SHARP_){
return debux.common.util.prepend_bars(p1__50074_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__50140 = cljs.core.next(opts__$1);
var G__50141 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50140;
acc = G__50141;
continue;
} else {
if(typeof f === 'string'){
var G__50142 = cljs.core.next(opts__$1);
var G__50143 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50142;
acc = G__50143;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50144 = cljs.core.nnext(opts__$1);
var G__50145 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50144;
acc = G__50145;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50146 = cljs.core.next(opts__$1);
var G__50147 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50146;
acc = G__50147;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50085 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50085.cljs$core$IFn$_invoke$arity$1 ? fexpr__50085.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50085.call(null,f));
})())){
var G__50148 = cljs.core.next(opts__$1);
var G__50149 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50148;
acc = G__50149;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50087 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50087.cljs$core$IFn$_invoke$arity$1 ? fexpr__50087.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50087.call(null,f));
})())){
var G__50150 = cljs.core.nnext(opts__$1);
var G__50151 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50150;
acc = G__50151;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50152 = cljs.core.next(opts__$1);
var G__50153 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50152;
acc = G__50153;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50091){
var vec__50092 = p__50091;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50092,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50092,(1),null);
...
var G__50097 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50096 = (function (){var fexpr__50098 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__50098.cljs$core$IFn$_invoke$arity$1 ? fexpr__50098.cljs$core$IFn$_invoke$arity$1(form) : fexpr__50098.call(null,form));
})();
return (fexpr__50096.cljs$core$IFn$_invoke$arity$1 ? fexpr__50096.cljs$core$IFn$_invoke$arity$1(G__50097) : fexpr__50096.call(null,G__50097));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50100 = quoted_form;
var G__50101 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50100,G__50101) : debux.common.util.remove_d.call(null,G__50100,G__50101));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50102 = quoted_form;
var G__50103 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50102,G__50103) : debux.common.util.remove_d.call(null,G__50102,G__50103));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__50154__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50104 = quoted_form;
var G__50105 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50104,G__50105) : debux.common.util.remove_d.call(null,G__50104,G__50105));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__50155__i < G__50155__a.length) {G__50155__a[G__50155__i] = arguments[G__50155__i + 0]; ++G__50155__i;}
  arg = new cljs.core.IndexedSeq(G__50155__a,0,null);
} 
return G__50154__delegate.call(this,arg);};
G__50154.cljs$lang$maxFixedArity = 0;
G__50154.cljs$lang$applyTo = (function (arglist__50156){
var arg = cljs.core.seq(arglist__50156);
return G__50154__delegate(arg);
});
...
var G__50157 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50157;
continue;
} else {
...
var G__50158 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50158;
continue;
} else {
var G__50159 = clojure.zip.next(loc);
loc = G__50159;
continue;
