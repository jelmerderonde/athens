...
var G__53988 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__53988__$1 = (((G__53988 == null))?null:cljs.core.persistent_BANG_(G__53988));
if((G__53988__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__53988__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__53991){
...
var frame = first__53994;
var frames = seq__53993__$1;
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53996__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53996__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_54099 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_54099,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__54009){
...
var parent = first__54013;
var frames = seq__54012__$1;
...
var found = cljs.core.not_empty((function (){var G__54015 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__54015);
} else {
return G__54015;
}
})());
...
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__54002_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__54002_SHARP_]);
}),G__54016);
} else {
return G__54016;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__54025 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54025,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__54025;
}
})());
...
var vec__54033 = p__54031;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54033,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54033,(1),null);
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__54044){
...
var frame = first__54047;
var frames = seq__54046__$1;
...
var vec__54051 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54051,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54051,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54054__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54054__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__54056 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__54056,attr,eid);
} else {
return G__54056;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54057__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54057__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__54067){
while(true){
var vec__54069 = p__54067;
var seq__54070 = cljs.core.seq(vec__54069);
var first__54071 = cljs.core.first(seq__54070);
var seq__54070__$1 = cljs.core.next(seq__54070);
var frame = first__54071;
var frames = seq__54070__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__54119 = db;
var G__54120 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__54119;
p__54067 = G__54120;
continue;
}
...
while(true){
var G__54073 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__54073__$1 = (((G__54073 instanceof cljs.core.Keyword))?G__54073.fqn:null);
switch (G__54073__$1) {
case "expand":
var G__54123 = db;
var G__54124 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__54123;
frames = G__54124;
continue;
...
case "expand-rev":
var G__54125 = db;
var G__54126 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__54125;
frames = G__54126;
continue;
...
case "pattern":
var G__54127 = db;
var G__54128 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__54127;
frames = G__54128;
continue;
...
case "recursion":
var G__54129 = db;
var G__54130 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__54129;
frames = G__54130;
continue;
...
break;
case "done":
var vec__54078 = frames;
var seq__54079 = cljs.core.seq(vec__54078);
var first__54080 = cljs.core.first(seq__54079);
var seq__54079__$1 = cljs.core.next(seq__54079);
var f = first__54080;
var remaining = seq__54079__$1;
var result = (function (){var G__54081 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__54081);
} else {
return G__54081;
}
})();
...
var G__54132 = db;
var G__54133 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__54082 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54082,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__54082;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54073__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__54083_SHARP_){
return datascript.db.entid_strict(db,p1__54083_SHARP_);
})),eids);
