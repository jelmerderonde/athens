...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54099__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54099__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__54113 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__54113__$1 = (((G__54113 == null))?null:cljs.core.persistent_BANG_(G__54113));
if((G__54113__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__54113__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__54118){
var vec__54119 = p__54118;
var seq__54120 = cljs.core.seq(vec__54119);
var first__54121 = cljs.core.first(seq__54120);
var seq__54120__$1 = cljs.core.next(seq__54120);
var frame = first__54121;
var frames = seq__54120__$1;
...
var results = (function (){var G__54122 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__54122,kvps);
} else {
return G__54122;
}
})();
...
var map__54128 = parent;
var map__54128__$1 = (((((!((map__54128 == null))))?(((((map__54128.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54128.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54128):map__54128);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54128__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54128__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_54287 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_54287,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__54150){
...
var parent = first__54153;
var frames = seq__54152__$1;
...
var found = cljs.core.not_empty((function (){var G__54154 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__54154);
} else {
return G__54154;
}
})());
...
var as_value = (function (){var G__54157 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__54144_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__54144_SHARP_]);
}),G__54157);
} else {
return G__54157;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__54161 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__54161);
} else {
return G__54161;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__54162 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54162,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__54162;
}
})());
...
var vec__54163 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54163,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54163,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__54169){
var vec__54172 = p__54169;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54172,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54172,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__54182){
var vec__54184 = p__54182;
...
var frame = first__54186;
var frames = seq__54185__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__54197){
...
var frame = first__54200;
var frames = seq__54199__$1;
...
var vec__54203 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54203,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54203,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54212__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54212__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__54220 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__54220,attr,eid);
} else {
return G__54220;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54222__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54222__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__54230){
while(true){
...
var frame = first__54233;
var frames = seq__54232__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__54312 = db;
var G__54313 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__54312;
p__54230 = G__54313;
continue;
}
...
while(true){
var G__54242 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__54242__$1 = (((G__54242 instanceof cljs.core.Keyword))?G__54242.fqn:null);
switch (G__54242__$1) {
case "expand":
var G__54315 = db;
var G__54316 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__54315;
frames = G__54316;
continue;
...
case "expand-rev":
var G__54317 = db;
var G__54318 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__54317;
frames = G__54318;
continue;
...
case "pattern":
var G__54319 = db;
var G__54320 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__54319;
frames = G__54320;
continue;
...
case "recursion":
var G__54321 = db;
var G__54322 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__54321;
frames = G__54322;
continue;
...
break;
case "done":
var vec__54246 = frames;
var seq__54247 = cljs.core.seq(vec__54246);
var first__54248 = cljs.core.first(seq__54247);
var seq__54247__$1 = cljs.core.next(seq__54247);
var f = first__54248;
var remaining = seq__54247__$1;
var result = (function (){var G__54251 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__54251);
} else {
return G__54251;
}
})();
...
var G__54323 = db;
var G__54324 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__54252 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54252,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__54252;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__54257_SHARP_){
return datascript.db.entid_strict(db,p1__54257_SHARP_);
})),eids);
