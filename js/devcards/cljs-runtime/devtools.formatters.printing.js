...
var len__4789__auto___43366 = arguments.length;
var i__4790__auto___43367 = (0);
while(true){
if((i__4790__auto___43367 < len__4789__auto___43366)){
args__4795__auto__.push((arguments[i__4790__auto___43367]));

var G__43368 = (i__4790__auto___43367 + (1));
i__4790__auto___43367 = G__43368;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43291){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43292,G__43293,seq43291__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43303_SHARP_){
return (!((cljs.core.meta(p1__43303_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43331__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43342){var _e__40220__auto__ = e43342;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e43347){var _e__40220__auto__ = e43347;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43353 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43354 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43354);

try{var map__43355 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43355__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43353);
}});
...
var temp__5733__auto___43379 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43379)){
var managed_print_level_43380 = temp__5733__auto___43379;
var _STAR_print_level_STAR__orig_val__43361_43381 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43362_43382 = managed_print_level_43380;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43362_43382);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43359_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43359_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43361_43381);
}} else {
job_fn();
}
