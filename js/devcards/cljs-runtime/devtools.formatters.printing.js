...
var len__4789__auto___41209 = arguments.length;
var i__4790__auto___41210 = (0);
while(true){
if((i__4790__auto___41210 < len__4789__auto___41209)){
args__4795__auto__.push((arguments[i__4790__auto___41210]));

var G__41211 = (i__4790__auto___41210 + (1));
i__4790__auto___41210 = G__41211;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41153){
var G__41154 = cljs.core.first(seq41153);
var seq41153__$1 = cljs.core.next(seq41153);
var G__41155 = cljs.core.first(seq41153__$1);
var seq41153__$2 = cljs.core.next(seq41153__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41154,G__41155,seq41153__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41175_SHARP_){
return (!((cljs.core.meta(p1__41175_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41183__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41190){var _e__40504__auto__ = e41190;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e41193){var _e__40504__auto__ = e41193;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41197 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41198 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41198);

try{var map__41199 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41199__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41197);
}});
...
var temp__5733__auto___41234 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41234)){
var managed_print_level_41235 = temp__5733__auto___41234;
var _STAR_print_level_STAR__orig_val__41203_41236 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41204_41237 = managed_print_level_41235;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41204_41237);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41201_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41201_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41203_41236);
}} else {
job_fn();
}
