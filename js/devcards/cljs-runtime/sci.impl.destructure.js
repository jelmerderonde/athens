...
var G__63464 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__63465 = n;
var G__63466 = cljs.core.nnext(bs);
var G__63467 = true;
ret = G__63464;
n = G__63465;
bs = G__63466;
seen_rest_QMARK_ = G__63467;
continue;
} else {
...
});})(G__63455,gmap,defaults,pvec,bents))
;
return fexpr__63454(G__63455);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__63446_SHARP_,p2__63447_SHARP_,(function (){var fexpr__63456 = cljs.core.val(entry);
return (fexpr__63456.cljs$core$IFn$_invoke$arity$1 ? fexpr__63456.cljs$core$IFn$_invoke$arity$1(p2__63447_SHARP_) : fexpr__63456.call(null,p2__63447_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__63457 = cljs.core.key(entry);
return (fexpr__63457.cljs$core$IFn$_invoke$arity$1 ? fexpr__63457.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__63457.call(null,bes));
})());
...
var G__63477 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__63478 = cljs.core.next(bes);
ret = G__63477;
bes = G__63478;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63448_SHARP_){
return (cljs.core.first(p1__63448_SHARP_) instanceof cljs.core.Keyword);
}),bents));
