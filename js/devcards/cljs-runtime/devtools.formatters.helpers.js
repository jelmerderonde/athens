...
var G__42831 = devtools.prefs.pref(v);
v = G__42831;
continue;
} else {
return v;
...
}catch (e42793){var _e__40220__auto__ = e42793;
return false;
}})();
...
}catch (e42800){var _e__40220__auto__ = e42800;
return false;
}})();
...
}catch (e42802){var _e__40220__auto__ = e42802;
return false;
}}
}
});
...
var vec__42807 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42807,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42807,(1),null);
...
return cljs.core.some((function (p1__42811_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42811_SHARP_);
}),template);
});
