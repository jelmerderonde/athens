...
var G__41148 = devtools.prefs.pref(v);
v = G__41148;
continue;
} else {
return v;
...
}catch (e41099){var _e__40504__auto__ = e41099;
return false;
}})();
...
}catch (e41103){var _e__40504__auto__ = e41103;
return false;
}})();
...
}catch (e41105){var _e__40504__auto__ = e41105;
return false;
}}
}
});
...
var vec__41124 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41124,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41124,(1),null);
...
return cljs.core.some((function (p1__41131_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41131_SHARP_);
}),template);
});
