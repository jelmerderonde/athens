...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60872){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60873__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60873__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60875 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60875 = (function (meta60876){
this.meta60876 = meta60876;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60875.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60877,meta60876__$1){
var self__ = this;
var _60877__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60875(meta60876__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60875.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60877){
var self__ = this;
var _60877__$1 = this;
return self__.meta60876;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60875.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60875.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60875.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60875.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60875.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60875");

(athens.devcards.spinner.t_athens$devcards$spinner60875.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60875");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60875.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60875 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60875(meta60876){
return (new athens.devcards.spinner.t_athens$devcards$spinner60875(meta60876));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60875(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60885 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60885 = (function (meta60886){
this.meta60886 = meta60886;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60885.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60887,meta60886__$1){
var self__ = this;
var _60887__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60885(meta60886__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60885.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60887){
var self__ = this;
var _60887__$1 = this;
return self__.meta60886;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60885.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60885.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60885.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60886","meta60886",-1195779112,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60885.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60885.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60885");

(athens.devcards.spinner.t_athens$devcards$spinner60885.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60885");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60885.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60885 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60885(meta60886){
return (new athens.devcards.spinner.t_athens$devcards$spinner60885(meta60886));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60885(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
