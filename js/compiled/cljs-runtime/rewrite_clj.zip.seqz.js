...
var G__49864 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__49864__$1 = (((G__49864 == null))?null:cljs.core.iterate((function (loc){
...
var G__49864__$2 = (((G__49864__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__49864__$1));
var G__49864__$3 = (((G__49864__$2 == null))?null:cljs.core.last(G__49864__$2));
if((G__49864__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__49864__$3);
}
} else {
return zloc;
}
...
var G__49925 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__49926 = rewrite_clj.zip.move.up(v);
loc = G__49925;
parent = G__49926;
continue;
} else {
var G__49927 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__49928 = parent;
loc = G__49927;
parent = G__49928;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__49894 = zloc;
var G__49894__$1 = (((G__49894 == null))?null:rewrite_clj.zip.move.down(G__49894));
var G__49894__$2 = (((G__49894__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__49894__$1,k));
if((G__49894__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__49894__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__49901 = rewrite_clj.zip.move.down(zloc);
var G__49901__$1 = (((G__49901 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__49901));
if((G__49901__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__49901__$1);
}
})(),k);
}
});
