...
var G__42485 = db;
var G__42486 = e;
var G__42487 = cljs.core.volatile_BANG_(false);
var G__42488 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__42485,G__42486,G__42487,G__42488) : datascript.impl.entity.__GT_Entity.call(null,G__42485,G__42486,G__42487,G__42488));
} else {
return null;
}
});
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42490_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__42491_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42493_SHARP_,p2__42494_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42493_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__42494_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__42513(s__42514){
return (new cljs.core.LazySeq(null,(function (){
var s__42514__$1 = s__42514;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42514__$1);
if(temp__5735__auto__){
var s__42514__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42514__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__42514__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42516 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42515 = (0);
while(true){
if((i__42515 < size__4581__auto__)){
var vec__42521 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42515);
...
cljs.core.chunk_append(b__42516,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__42727 = (i__42515 + (1));
i__42515 = G__42727;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42516),datascript$impl$entity$js_seq_$_iter__42513(cljs.core.chunk_rest(s__42514__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42516),null);
}
} else {
var vec__42529 = cljs.core.first(s__42514__$2);
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__42513(cljs.core.rest(s__42514__$2)));
}
} else {
return null;
}
...
var vec__42594 = chunk__42572.cljs$core$IIndexed$_nth$arity$2(null,i__42574);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42594,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42594,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42744 = seq__42571;
var G__42745 = chunk__42572;
var G__42746 = count__42573;
var G__42747 = (i__42574 + (1));
seq__42571 = G__42744;
chunk__42572 = G__42745;
count__42573 = G__42746;
i__42574 = G__42747;
continue;
} else {
...
var G__42753 = cljs.core.chunk_rest(seq__42571__$1);
var G__42754 = c__4609__auto__;
var G__42755 = cljs.core.count(c__4609__auto__);
var G__42756 = (0);
seq__42571 = G__42753;
chunk__42572 = G__42754;
count__42573 = G__42755;
i__42574 = G__42756;
continue;
} else {
var vec__42599 = cljs.core.first(seq__42571__$1);
...
var G__42757 = cljs.core.next(seq__42571__$1);
var G__42758 = null;
var G__42759 = (0);
var G__42760 = (0);
seq__42571 = G__42757;
chunk__42572 = G__42758;
count__42573 = G__42759;
i__42574 = G__42760;
continue;
}
} else {
...
var G__42741__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__42604 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42605 = null;
var count__42606 = (0);
var i__42607 = (0);
while(true){
if((i__42607 < count__42606)){
var vec__42621 = chunk__42605.cljs$core$IIndexed$_nth$arity$2(null,i__42607);
...
var G__42764 = seq__42604;
var G__42765 = chunk__42605;
var G__42766 = count__42606;
var G__42767 = (i__42607 + (1));
seq__42604 = G__42764;
chunk__42605 = G__42765;
count__42606 = G__42766;
i__42607 = G__42767;
continue;
} else {
...
var c__4609__auto__ = cljs.core.chunk_first(seq__42604__$1);
var G__42769 = cljs.core.chunk_rest(seq__42604__$1);
var G__42770 = c__4609__auto__;
var G__42771 = cljs.core.count(c__4609__auto__);
var G__42772 = (0);
seq__42604 = G__42769;
chunk__42605 = G__42770;
count__42606 = G__42771;
i__42607 = G__42772;
continue;
} else {
var vec__42628 = cljs.core.first(seq__42604__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42628,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42628,(1),null);
f.call(use_as_this,v,a,this$);


var G__42783 = cljs.core.next(seq__42604__$1);
var G__42784 = null;
var G__42785 = (0);
var G__42786 = (0);
seq__42604 = G__42783;
chunk__42605 = G__42784;
count__42606 = G__42785;
i__42607 = G__42786;
continue;
}
} else {
...
G__42741 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__42741__1.call(this,f);
case 2:
return G__42741__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__42741.cljs$core$IFn$_invoke$arity$1 = G__42741__1;
G__42741.cljs$core$IFn$_invoke$arity$2 = G__42741__2;
return G__42741;
})()
);
...
var G__42635 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__42635);
} else {
return G__42635;
}
}
...
var self__ = this;
var this$__$1 = this;
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353),(function (){var G__42657 = this$__$1;
var G__42658 = k;
var G__42659 = new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353);
return (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3(G__42657,G__42658,G__42659) : datascript.impl.entity.lookup_entity.call(null,G__42657,G__42658,G__42659));
})());
}));
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args42563){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args42563)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__42691 = cljs.core.deref(this$.cache);
return (fexpr__42691.cljs$core$IFn$_invoke$arity$1 ? fexpr__42691.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__42691.call(null,attr));
})();
