...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62990__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62990__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__63003 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__63003__$1 = (((G__63003 == null))?null:cljs.core.persistent_BANG_(G__63003));
if((G__63003__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__63003__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__63006){
var vec__63007 = p__63006;
var seq__63008 = cljs.core.seq(vec__63007);
var first__63009 = cljs.core.first(seq__63008);
var seq__63008__$1 = cljs.core.next(seq__63008);
var frame = first__63009;
var frames = seq__63008__$1;
...
var results = (function (){var G__63011 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__63011,kvps);
} else {
return G__63011;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63014__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63014__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_63119 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_63119,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__63026){
...
var parent = first__63029;
var frames = seq__63028__$1;
...
var found = cljs.core.not_empty((function (){var G__63037 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__63037);
} else {
return G__63037;
}
})());
...
var as_value = (function (){var G__63039 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__63025_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__63025_SHARP_]);
}),G__63039);
} else {
return G__63039;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__63041 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__63041);
} else {
return G__63041;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__63043 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__63043,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__63043;
}
})());
...
var vec__63047 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63047,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63047,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__63050){
var vec__63051 = p__63050;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63051,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63051,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__63055){
var vec__63059 = p__63055;
...
var frame = first__63061;
var frames = seq__63060__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__63062){
var vec__63063 = p__63062;
var seq__63064 = cljs.core.seq(vec__63063);
var first__63065 = cljs.core.first(seq__63064);
var seq__63064__$1 = cljs.core.next(seq__63064);
var frame = first__63065;
var frames = seq__63064__$1;
...
var vec__63066 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63066,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63066,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63069__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63069__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__63072 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__63072,attr,eid);
} else {
return G__63072;
}
})();
...
var map__63081 = frame;
var map__63081__$1 = (((((!((map__63081 == null))))?(((((map__63081.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63081.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63081):map__63081);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63081__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63081__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__63085){
while(true){
var vec__63089 = p__63085;
...
var frame = first__63091;
var frames = seq__63090__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__63135 = db;
var G__63136 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__63135;
p__63085 = G__63136;
continue;
}
...
while(true){
var G__63092 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__63092__$1 = (((G__63092 instanceof cljs.core.Keyword))?G__63092.fqn:null);
switch (G__63092__$1) {
case "expand":
var G__63139 = db;
var G__63140 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__63139;
frames = G__63140;
continue;
...
case "expand-rev":
var G__63141 = db;
var G__63142 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__63141;
frames = G__63142;
continue;
...
case "pattern":
var G__63143 = db;
var G__63144 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__63143;
frames = G__63144;
continue;
...
case "recursion":
var G__63145 = db;
var G__63146 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__63145;
frames = G__63146;
continue;
...
break;
case "done":
var vec__63093 = frames;
var seq__63094 = cljs.core.seq(vec__63093);
var first__63095 = cljs.core.first(seq__63094);
var seq__63094__$1 = cljs.core.next(seq__63094);
var f = first__63095;
var remaining = seq__63094__$1;
var result = (function (){var G__63096 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__63096);
} else {
return G__63096;
}
})();
...
var G__63151 = db;
var G__63152 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__63098 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__63098,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__63098;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63092__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__63099_SHARP_){
return datascript.db.entid_strict(db,p1__63099_SHARP_);
})),eids);
