...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65467__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65467__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__65469 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__65469__$1 = (((G__65469 == null))?null:cljs.core.persistent_BANG_(G__65469));
if((G__65469__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__65469__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__65474){
var vec__65475 = p__65474;
var seq__65476 = cljs.core.seq(vec__65475);
var first__65477 = cljs.core.first(seq__65476);
var seq__65476__$1 = cljs.core.next(seq__65476);
var frame = first__65477;
var frames = seq__65476__$1;
...
var results = (function (){var G__65479 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__65479,kvps);
} else {
return G__65479;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65480__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65480__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_65602 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_65602,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__65507){
var vec__65510 = p__65507;
...
var parent = first__65512;
var frames = seq__65511__$1;
...
var found = cljs.core.not_empty((function (){var G__65513 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__65513);
} else {
return G__65513;
}
})());
...
var as_value = (function (){var G__65514 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__65482_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__65482_SHARP_]);
}),G__65514);
} else {
return G__65514;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__65515 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__65515);
} else {
return G__65515;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__65516 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__65516,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__65516;
}
})());
...
var vec__65520 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65520,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65520,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__65524){
var vec__65525 = p__65524;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65525,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65525,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__65537){
var vec__65538 = p__65537;
var seq__65539 = cljs.core.seq(vec__65538);
var first__65540 = cljs.core.first(seq__65539);
var seq__65539__$1 = cljs.core.next(seq__65539);
var frame = first__65540;
var frames = seq__65539__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__65541){
var vec__65543 = p__65541;
var seq__65544 = cljs.core.seq(vec__65543);
var first__65545 = cljs.core.first(seq__65544);
var seq__65544__$1 = cljs.core.next(seq__65544);
var frame = first__65545;
var frames = seq__65544__$1;
...
var vec__65546 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65546,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65546,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65549__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65549__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__65552 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__65552,attr,eid);
} else {
return G__65552;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65553__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65553__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__65555){
while(true){
var vec__65557 = p__65555;
...
var frame = first__65559;
var frames = seq__65558__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__65649 = db;
var G__65650 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__65649;
p__65555 = G__65650;
continue;
}
...
while(true){
var G__65568 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__65568__$1 = (((G__65568 instanceof cljs.core.Keyword))?G__65568.fqn:null);
switch (G__65568__$1) {
case "expand":
var G__65660 = db;
var G__65661 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__65660;
frames = G__65661;
continue;
...
case "expand-rev":
var G__65663 = db;
var G__65664 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__65663;
frames = G__65664;
continue;
...
case "pattern":
var G__65665 = db;
var G__65666 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__65665;
frames = G__65666;
continue;
...
case "recursion":
var G__65667 = db;
var G__65668 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__65667;
frames = G__65668;
continue;
...
break;
case "done":
var vec__65570 = frames;
var seq__65571 = cljs.core.seq(vec__65570);
var first__65572 = cljs.core.first(seq__65571);
var seq__65571__$1 = cljs.core.next(seq__65571);
var f = first__65572;
var remaining = seq__65571__$1;
var result = (function (){var G__65573 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__65573);
} else {
return G__65573;
}
})();
...
var G__65671 = db;
var G__65672 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__65574 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__65574,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__65574;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65568__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__65575_SHARP_){
return datascript.db.entid_strict(db,p1__65575_SHARP_);
})),eids);
