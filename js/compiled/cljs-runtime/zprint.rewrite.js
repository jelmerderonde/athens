...
var G__50481 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__50481;
continue;
} else {
...
var G__50483 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__50483;
continue;
}
}
...
var G__50475 = zloc;
var G__50476 = (function (){var G__50477 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__50478 = zloc;
var G__50478__$1 = (((G__50478 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__50478) : rewrite_clj.zip.node.call(null,G__50478)));
if((G__50478__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50478__$1) : zprint.zutil.edn_STAR_.call(null,G__50478__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__50477) : rewrite_clj.zip.root.call(null,G__50477));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__50475,G__50476) : rewrite_clj.zip.replace.call(null,G__50475,G__50476));
});
/**
...
var G__50484 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__50484;
continue;
}
break;
...
var G__50485 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__50486 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__50485;
out = G__50486;
continue;
} else {
...
var G__50487 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__50488 = cljs.core.next(new_loc);
var G__50489 = replaced_loc;
nloc = G__50487;
new_loc = G__50488;
last_loc = G__50489;
continue;
...
return zprint.rewrite.sort_val((function (){var G__50479 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__50479) : rewrite_clj.zip.down.call(null,G__50479));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__50480_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__50480_SHARP_) : rewrite_clj.zip.tag.call(null,p1__50480_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__50480_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__50480_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
