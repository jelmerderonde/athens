...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__50192,k,f){
var vec__50193 = p__50192;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50193,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50193,(1),null);
var loc = vec__50193;
...
var G__50216 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50216;
continue;
}
break;
...
var G__50217 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50217;
continue;
} else {
return zloc__$1;
...
var G__50218 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50218;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50198){
var vec__50199 = p__50198;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50199,(0),null);
...
var path = map__50202__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50202__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__50199;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50204){
var vec__50205 = p__50204;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50205,(0),null);
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50208__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50205;
if(cljs.core.seq(r)){
...
var vec__50210 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50210,(0),null);
var map__50213 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50210,(1),null);
...
var path = map__50213__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50213__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50213__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50213__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50213__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
