 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__68135){
var vec__68136 = p__68135;
var seq__68137 = cljs.core.seq(vec__68136);
var first__68138 = cljs.core.first(seq__68137);
var seq__68137__$1 = cljs.core.next(seq__68137);
var k = first__68138;
var ks = seq__68137__$1;
var keys = vec__68136;
if(ks){
...
var G__68147 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__68148 = now_seen_events;
var fexpr__68146 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__68146.cljs$core$IFn$_invoke$arity$2 ? fexpr__68146.cljs$core$IFn$_invoke$arity$2(G__68147,G__68148) : fexpr__68146.call(null,G__68147,G__68148));
...
var G__68158 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__68159 = "async-flow: got bad value for :when - ";
var G__68160 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__68158,G__68159,G__68160) : re_frame.core.console.call(null,G__68158,G__68159,G__68160));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__68175){
...
var rule = map__68176__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68176__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__68185 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__68186 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__68187 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__68185,G__68186,G__68187) : re_frame.core.console.call(null,G__68185,G__68186,G__68187));
} else {
var G__68188 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__68188__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68188,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__68188);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68188__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__68188__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68192__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68192__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__68196 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__68197 = "async-flow: dispatch-fn must return a seq of events ";
var G__68198 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__68196,G__68197,G__68198) : re_frame.core.console.call(null,G__68196,G__68197,G__68198));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__68201){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68202__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68202__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68202__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68202__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__68204,p__68205){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68206__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__68207 = p__68205;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68207,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68207,(1),null);
var event_v = vec__68207;
var pred__68211 = cljs.core._EQ_;
var expr__68212 = event_type;
if(cljs.core.truth_((function (){var G__68214 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__68215 = expr__68212;
return (pred__68211.cljs$core$IFn$_invoke$arity$2 ? pred__68211.cljs$core$IFn$_invoke$arity$2(G__68214,G__68215) : pred__68211.call(null,G__68214,G__68215));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__68216 = db;
var G__68217 = cljs.core.PersistentHashSet.EMPTY;
var G__68218 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__68216,G__68217,G__68218) : set_state.call(null,G__68216,G__68217,G__68218));
...
var vec__68219 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68219,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68219,(1),null);
var map__68222 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68222__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68222__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__68227 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68227,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68227,(1),null);
...
var G__68230 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__68230) : re_frame.core.dispatch.call(null,G__68230));
});
var G__68231_68247 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__68232_68248 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__68231_68247,G__68232_68248) : re_frame.core.reg_fx.call(null,G__68231_68247,G__68232_68248));
