 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__67856){
var vec__67857 = p__67856;
var seq__67858 = cljs.core.seq(vec__67857);
var first__67859 = cljs.core.first(seq__67858);
var seq__67858__$1 = cljs.core.next(seq__67858);
var k = first__67859;
var ks = seq__67858__$1;
var keys = vec__67857;
if(ks){
...
var G__67871 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__67872 = now_seen_events;
var fexpr__67870 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__67870.cljs$core$IFn$_invoke$arity$2 ? fexpr__67870.cljs$core$IFn$_invoke$arity$2(G__67871,G__67872) : fexpr__67870.call(null,G__67871,G__67872));
...
var G__67874 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__67875 = "async-flow: got bad value for :when - ";
var G__67876 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__67874,G__67875,G__67876) : re_frame.core.console.call(null,G__67874,G__67875,G__67876));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__67877){
...
var rule = map__67878__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67878__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__67882 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__67883 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__67884 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__67882,G__67883,G__67884) : re_frame.core.console.call(null,G__67882,G__67883,G__67884));
} else {
var G__67886 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__67886__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67886,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__67886);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67886__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__67886__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67892__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67892__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__67894 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__67895 = "async-flow: dispatch-fn must return a seq of events ";
var G__67896 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__67894,G__67895,G__67896) : re_frame.core.console.call(null,G__67894,G__67895,G__67896));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__67897){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67898__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67898__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67898__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67898__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__67901,p__67902){
var map__67903 = p__67901;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67903__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__67904 = p__67902;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67904,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67904,(1),null);
var event_v = vec__67904;
var pred__67908 = cljs.core._EQ_;
var expr__67909 = event_type;
if(cljs.core.truth_((function (){var G__67911 = new cljs.core.Keyword(null,"setup","setup",1987730512);
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__67913 = db;
var G__67914 = cljs.core.PersistentHashSet.EMPTY;
var G__67915 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__67913,G__67914,G__67915) : set_state.call(null,G__67913,G__67914,G__67915));
...
var vec__67916 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67916,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67916,(1),null);
var map__67919 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67919__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67919__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__67956 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67956,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67956,(1),null);
...
var G__67959 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__67959) : re_frame.core.dispatch.call(null,G__67959));
});
var G__67960_68093 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__67961_68094 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__67960_68093,G__67961_68094) : re_frame.core.reg_fx.call(null,G__67960_68093,G__67961_68094));
