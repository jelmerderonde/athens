...
var vec__75157 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75157,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75157,(1),null);
...
var vec__75160 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75160,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75160,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__75164 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75164,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75164,(1),null);
...
var G__75299 = cljs.core.next(parses__$1);
parses__$1 = G__75299;
continue;
}
...
var G__75182 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__75183 = G__75182;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75183,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75183,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75183,(2),null);
var selection = vec__75183;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__75182__$1 = G__75182;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__75195 = G__75182__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75195,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75195,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75195,(2),null);
var selection__$1 = vec__75195;
...
var G__75303 = cljs.core.long$(end__$1);
var G__75304 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__75305 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__75303;
parses__$1 = G__75304;
G__75182__$1 = G__75305;
continue;
...
var G__75209 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__75210 = G__75209;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75210,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75210,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75210,(2),null);
var selection = vec__75210;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__75209__$1 = G__75209;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__75217 = G__75209__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75217,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75217,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75217,(2),null);
var selection__$1 = vec__75217;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__75332 = cljs.core.long$(end__$1);
var G__75333 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__75334 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__75332;
parses__$1 = G__75333;
G__75209__$1 = G__75334;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__75245 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__75246 = G__75245;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75246,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75246,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75246,(2),null);
var selection = vec__75246;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__75245__$1 = G__75245;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__75257 = G__75245__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75257,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75257,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75257,(2),null);
var selection__$1 = vec__75257;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__75341 = cljs.core.long$(end__$1);
var G__75342 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__75343 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__75341;
parses__$1 = G__75342;
G__75245__$1 = G__75343;
continue;
...
if(cljs.core.truth_((function (){var fexpr__75266 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__75266.cljs$core$IFn$_invoke$arity$1 ? fexpr__75266.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__75266.call(null,output_format));
})())){
} else {
...
var G__75271 = output_format;
var G__75271__$1 = (((G__75271 instanceof cljs.core.Keyword))?G__75271.fqn:null);
switch (G__75271__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__75286 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__75285 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__75285.cljs$core$IFn$_invoke$arity$1 ? fexpr__75285.cljs$core$IFn$_invoke$arity$1(G__75286) : fexpr__75285.call(null,G__75286));
})();
