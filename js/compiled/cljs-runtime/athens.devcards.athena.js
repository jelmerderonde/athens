...
var G__54076_54138 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"init-rfdb","init-rfdb",-460710127)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__54076_54138) : re_frame.core.dispatch.call(null,G__54076_54138));
...
var G__54087 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__54087) : re_frame.core.dispatch.call(null,G__54087));
...
var G__54147 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__54147;
continue;
}
break;
...
var athena_QMARK_ = (function (){var G__54112 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athena","athena",-1523991628)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__54112) : re_frame.core.subscribe.call(null,G__54112));
})();
...
var G__54113 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pages","pages",-285406513),athens.devcards.athena.search_in_block_title(db,query)], null);
if(cljs.core.truth_(cljs.core.count(query))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54113,new cljs.core.Keyword(null,"blocks","blocks",-610462153),athens.devcards.athena.search_in_block_content(db,query));
} else {
return G__54113;
}
}
...
var vec__54116 = cljs.core.deref(_STAR_match);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54116,(0),null);
var map__54119 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54116,(1),null);
...
var result = map__54119__$1;
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54119__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54119__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
if(cljs.core.truth_(result)){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),athens.lib.dom.attributes.with_styles.cljs$core$IFn$_invoke$arity$1(athens.devcards.athena._PLUS_query),(function (){var iter__4582__auto__ = (function athens$devcards$athena$athena_$_iter__54121(s__54122){
return (new cljs.core.LazySeq(null,(function (){
var s__54122__$1 = s__54122;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54122__$1);
if(temp__5735__auto__){
var s__54122__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54122__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__54122__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__54124 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__54123 = (0);
while(true){
if((i__54123 < size__4581__auto__)){
var vec__54127 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__54123);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54127,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54127,(1),null);
cljs.core.chunk_append(b__54124,(function (){var parent = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(x);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),athens.lib.dom.attributes.with_attributes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"athena-result",new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__54123,parent,page_title,block_uid,block_string,vec__54127,i,x,c__4580__auto__,size__4581__auto__,b__54124,s__54122__$2,temp__5735__auto__,vec__54116,query,map__54119,map__54119__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler){
return (function (){
return athens.router.navigate_page(block_uid);
});})(i__54123,parent,page_title,block_uid,block_string,vec__54127,i,x,c__4580__auto__,size__4581__auto__,b__54124,s__54122__$2,temp__5735__auto__,vec__54116,query,map__54119,map__54119__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54124),athens$devcards$athena$athena_$_iter__54121(cljs.core.chunk_rest(s__54122__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54124),null);
}
} else {
var vec__54133 = cljs.core.first(s__54122__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54133,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54133,(1),null);
...
var block_string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(x);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),athens.lib.dom.attributes.with_attributes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"athena-result",new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (parent,page_title,block_uid,block_string,vec__54133,i,x,s__54122__$2,temp__5735__auto__,vec__54116,query,map__54119,map__54119__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler){
return (function (){
return athens.router.navigate_page(block_uid);
});})(parent,page_title,block_uid,block_string,vec__54133,i,x,s__54122__$2,temp__5735__auto__,vec__54116,query,map__54119,map__54119__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler))
], null)], 0)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),athens.devcards.athena.highlight_match(query,page_title)], null),(cljs.core.truth_(block_string)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),athens.devcards.athena.highlight_match(query,block_string)], null):null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),athens.lib.dom.attributes.with_styles.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"auto"], null)),"\u27A1\uFE0F"], null)], null);
})(),athens$devcards$athena$athena_$_iter__54121(cljs.core.rest(s__54122__$2)));
}
} else {
return null;
}
