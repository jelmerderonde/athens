...
var vec__52595 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__52602 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52602,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52602,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52595,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52595,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__52611){
var vec__52612 = p__52611;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52612,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52612,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52617,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52617,(1),null);
...
var vec__52624 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52624,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52624,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52624,(2),null);
var vec__52627 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52627,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52627,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52627,(2),null);
...
var G__52634 = special_option;
var G__52634__$1 = (((G__52634 instanceof cljs.core.Keyword))?G__52634.fqn:null);
switch (G__52634__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__52640){
var vec__52641 = p__52640;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52641,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52641,(1),null);
...
var len__4789__auto___52820 = arguments.length;
var i__4790__auto___52821 = (0);
while(true){
if((i__4790__auto___52821 < len__4789__auto___52820)){
args__4795__auto__.push((arguments[i__4790__auto___52821]));

var G__52822 = (i__4790__auto___52821 + (1));
i__4790__auto___52821 = G__52822;
continue;
} else {
}
break;
...
var vec__52647 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52647,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52647,(1),null);
...
var G__52650 = zprint.core.parse_string_all_options(rest_options);
var G__52651 = zprint.core.zprint_str_internal;
var G__52652 = ":parse-string-all? call";
var G__52653 = (function (){var G__52654 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52654) : zprint.zutil.edn_STAR_.call(null,G__52654));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__52650,G__52651,G__52652,G__52653) : zprint.core.process_multiple_forms.call(null,G__52650,G__52651,G__52652,G__52653));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__52655 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52655,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52655,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq52644){
var G__52645 = cljs.core.first(seq52644);
var seq52644__$1 = cljs.core.next(seq52644);
var G__52646 = cljs.core.first(seq52644__$1);
var seq52644__$2 = cljs.core.next(seq52644__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52645,G__52646,seq52644__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___52832 = arguments.length;
var i__4790__auto___52834 = (0);
while(true){
if((i__4790__auto___52834 < len__4789__auto___52832)){
args__4795__auto__.push((arguments[i__4790__auto___52834]));

var G__52836 = (i__4790__auto___52834 + (1));
i__4790__auto___52834 = G__52836;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq52686){
var G__52687 = cljs.core.first(seq52686);
var seq52686__$1 = cljs.core.next(seq52686);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52687,seq52686__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___52844 = arguments.length;
var i__4790__auto___52845 = (0);
while(true){
if((i__4790__auto___52845 < len__4789__auto___52844)){
args__4795__auto__.push((arguments[i__4790__auto___52845]));

var G__52846 = (i__4790__auto___52845 + (1));
i__4790__auto___52845 = G__52846;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq52707){
var G__52712 = cljs.core.first(seq52707);
var seq52707__$1 = cljs.core.next(seq52707);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52712,seq52707__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___52850 = arguments.length;
var i__4790__auto___52851 = (0);
while(true){
if((i__4790__auto___52851 < len__4789__auto___52850)){
args__4795__auto__.push((arguments[i__4790__auto___52851]));

var G__52852 = (i__4790__auto___52851 + (1));
i__4790__auto___52851 = G__52852;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq52727){
...
var args__4795__auto__ = [];
var len__4789__auto___52854 = arguments.length;
var i__4790__auto___52855 = (0);
while(true){
if((i__4790__auto___52855 < len__4789__auto___52854)){
args__4795__auto__.push((arguments[i__4790__auto___52855]));

var G__52856 = (i__4790__auto___52855 + (1));
i__4790__auto___52855 = G__52856;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq52741){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__52775,form){
var vec__52776 = p__52775;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52776,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52776,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52776,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52776,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__52779 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52779,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52779,(1),null);
...
var forms = (function (){var G__52790 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52790) : zprint.zutil.edn_STAR_.call(null,G__52790));
})();
