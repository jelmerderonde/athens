...
var o42622 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42622["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42623 = temp__5733__auto____$1;
return (o42623["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40225__auto__ = f;
return (o__40225__auto__["toString"]).call(o__40225__auto__);
} else {
return "";
}
}catch (e42624){var _ = e42624;
return "";
}});
...
try{var o__40225__auto___42818 = t;
(o__40225__auto___42818["cljs$lang$ctorPrWriter"]).call(o__40225__auto___42818,t,writer);
}catch (e42625){var __42819 = e42625;
}
...
var char_code = (function (){var o__40225__auto__ = (new String(char$));
return (o__40225__auto__["charCodeAt"]).call(o__40225__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40225__auto__ = String;
return (o__40225__auto__["fromCharCode"]).call(o__40225__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42626 = num_code;
switch (G__42626) {
case (1):
return (185);
...
var o__40225__auto__ = String;
return (o__40225__auto__["fromCharCode"]).call(o__40225__auto__,superscript_code);
});
/**
...
}catch (e42627){var _e__40232__auto__ = e42627;
return false;
}})())){
...
var vec__42628 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42628,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42631 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42631["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42632 = temp__5733__auto____$1;
return (o42632["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42635){
var vec__42636 = p__42635;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42636,(0),null);
...
var G__42838 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42839 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42838;
remaining_tokens = G__42839;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42633){
...
var vec__42641 = cljs.core.split_with((function (p1__42640_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42640_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42641,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42641,(1),null);
...
var vec__42647 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42647,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42647,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42845 = cljs.core.rest(remaining_tokens);
var G__42846 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42845;
name_tokens = G__42846;
continue;
} else {
...
var G__42873 = (arity + (1));
var G__42874 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42678){
var vec__42679 = p__42678;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42679,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42679,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42682_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42682_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42683_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42683_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42694){
var vec__42695 = p__42694;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42695,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42690){
var G__42691 = cljs.core.first(seq42690);
var seq42690__$1 = cljs.core.next(seq42690);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42691,seq42690__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42734 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42734,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42734,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42734,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42734,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42734,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42734,(5),null);
...
var o__40225__auto__ = f;
return (o__40225__auto__["getBasis"]).call(o__40225__auto__);
});
/**
...
}catch (e42738){var _e__40232__auto__ = e42738;
...
var G__42893 = (obj[cljs.core.first(path)]);
var G__42894 = cljs.core.rest(path);
obj = G__42893;
path = G__42894;
continue;
} else {
...
var _STAR_ = (function (accum,p__42759){
var vec__42760 = p__42759;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42760,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42760,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42767){
var vec__42768 = p__42767;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42768,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42768,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42768,(2),null);
...
var post_process = (function (p__42795){
var vec__42796 = p__42795;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42796,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42796,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42779_SHARP_){
return (obj[cljs.core.first(p1__42779_SHARP_)]);
}),sorted_matches);
