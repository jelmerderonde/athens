...
var o40856 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40856["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40857 = temp__5733__auto____$1;
return (o40857["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40415__auto__ = f;
return (o__40415__auto__["toString"]).call(o__40415__auto__);
} else {
return "";
}
}catch (e40858){var _ = e40858;
return "";
}});
...
try{var o__40415__auto___41068 = t;
(o__40415__auto___41068["cljs$lang$ctorPrWriter"]).call(o__40415__auto___41068,t,writer);
}catch (e40860){var __41069 = e40860;
}
...
var char_code = (function (){var o__40415__auto__ = (new String(char$));
return (o__40415__auto__["charCodeAt"]).call(o__40415__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40415__auto__ = String;
return (o__40415__auto__["fromCharCode"]).call(o__40415__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40874 = num_code;
switch (G__40874) {
case (1):
return (185);
...
var o__40415__auto__ = String;
return (o__40415__auto__["fromCharCode"]).call(o__40415__auto__,superscript_code);
});
/**
...
}catch (e40876){var _e__40458__auto__ = e40876;
return false;
}})())){
...
var vec__40877 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40877,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o40887 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40887["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40888 = temp__5733__auto____$1;
return (o40888["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40895){
var vec__40896 = p__40895;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40896,(0),null);
...
var G__41112 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41113 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41112;
remaining_tokens = G__41113;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40890){
...
var vec__40902 = cljs.core.split_with((function (p1__40901_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40901_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40902,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40902,(1),null);
...
var vec__40925 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40925,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40925,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41134 = cljs.core.rest(remaining_tokens);
var G__41135 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41134;
name_tokens = G__41135;
continue;
} else {
...
var vec__40933 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40933,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40933,(1),null);
var vec__40936 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40936,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40936,(1),null);
var vec__40939 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40939,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40939,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40939,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40939,(3),null);
...
var vec__40944 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40944,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40944,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40944,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40944,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40944,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40944,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__40948 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40948,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40948,(1),null);
var vec__40960 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40960,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40960,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__40964 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__40964) : devtools.munging.parse_fn_info_deep.call(null,G__40964));
})()));
}
} else {
return fn_info;
...
var G__41177 = (arity + (1));
var G__41178 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40971){
var vec__40972 = p__40971;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40972,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40972,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40986_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__40986_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40987_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__40987_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___41187 = arguments.length;
var i__4790__auto___41192 = (0);
while(true){
if((i__4790__auto___41192 < len__4789__auto___41187)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40991){
var vec__40992 = p__40991;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40992,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40988){
...
var G__41000 = arg;
var G__41000__$1 = (((G__41000 instanceof cljs.core.Keyword))?G__41000.fqn:null);
switch (G__41000__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41010__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41010__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41010__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41010__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41011 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41011,(5),null);
...
var o__40415__auto__ = f;
return (o__40415__auto__["getBasis"]).call(o__40415__auto__);
});
/**
...
}catch (e41026){var _e__40458__auto__ = e41026;
...
var G__41206 = (obj[cljs.core.first(path)]);
var G__41207 = cljs.core.rest(path);
obj = G__41206;
path = G__41207;
continue;
} else {
...
var _STAR_ = (function (accum,p__41038){
var vec__41039 = p__41038;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41039,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41039,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41042){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41043,(2),null);
...
var post_process = (function (p__41063){
var vec__41064 = p__41063;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41064,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41064,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41047_SHARP_){
return (obj[cljs.core.first(p1__41047_SHARP_)]);
}),sorted_matches);
