...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__65893,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__65894__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65894__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65894__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65894__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65894__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__65923 = cljs.core.next(args__$1);
var G__65924 = cljs.core.next(params__$1);
var G__65925 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__65923;
params__$1 = G__65924;
ret = G__65925;
continue;
...
var vec__65899 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65899,(0),null);
var vec__65902 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65899,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65902,(0),null);
var G__65926 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__65926;
continue;
} else {
var G__65928 = recur_val;
args = G__65928;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__65933){
...
var map__65905 = cljs.core.meta(f);
...
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65905__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65911){
...
var f = map__65912__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65912__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65912__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__65943__i < G__65943__a.length) {G__65943__a[G__65943__i] = arguments[G__65943__i + 0]; ++G__65943__i;}
  args = new cljs.core.IndexedSeq(G__65943__a,0,null);
} 
return G__65940__delegate.call(this,args);};
G__65940.cljs$lang$maxFixedArity = 0;
G__65940.cljs$lang$applyTo = (function (arglist__65944){
var args = cljs.core.seq(arglist__65944);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65909_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65909_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__65951__delegate = function (args){
...
var G__65951 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__65951__delegate.call(this,args);};
G__65951.cljs$lang$maxFixedArity = 0;
G__65951.cljs$lang$applyTo = (function (arglist__65957){
var args = cljs.core.seq(arglist__65957);
return G__65951__delegate(args);
});
G__65951.cljs$core$IFn$_invoke$arity$variadic = G__65951__delegate;
return G__65951;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65910_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65910_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
