...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__49088){
var vec__49089 = p__49088;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49089,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__49099_SHARP_){
return (((p1__49099_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__49099_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49103,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__49103;
}
});
...
var len__4789__auto___49148 = arguments.length;
var i__4790__auto___49149 = (0);
while(true){
if((i__4790__auto___49149 < len__4789__auto___49148)){
args__4795__auto__.push((arguments[i__4790__auto___49149]));

var G__49150 = (i__4790__auto___49149 + (1));
i__4790__auto___49149 = G__49150;
continue;
} else {
}
break;
...
var G__49105 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49105,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__49105;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq49104){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49104));
}));
...
var vec__49111 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__49127 = cljs.core.ffirst(matches);
var fexpr__49126 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__49126.cljs$core$IFn$_invoke$arity$1 ? fexpr__49126.cljs$core$IFn$_invoke$arity$1(G__49127) : fexpr__49126.call(null,G__49127));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49111,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49111,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__49106_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__49106_SHARP_))){
return p1__49106_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__49107_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__49107_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__49132){
var vec__49133 = p__49132;
var seq__49134 = cljs.core.seq(vec__49133);
var first__49135 = cljs.core.first(seq__49134);
var seq__49134__$1 = cljs.core.next(seq__49134);
var tag = first__49135;
var content = seq__49134__$1;
...
var vec__49136 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49136,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49136,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49136,(2),null);
