...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__50167){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__50171_SHARP_){
return (((p1__50171_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__50171_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__50172,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__50172;
}
});
...
var len__4789__auto___50202 = arguments.length;
var i__4790__auto___50203 = (0);
while(true){
if((i__4790__auto___50203 < len__4789__auto___50202)){
args__4795__auto__.push((arguments[i__4790__auto___50203]));

var G__50204 = (i__4790__auto___50203 + (1));
i__4790__auto___50203 = G__50204;
continue;
} else {
}
break;
...
var G__50174 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50174,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__50174;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq50173){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50173));
}));
...
var vec__50177 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__50181 = cljs.core.ffirst(matches);
var fexpr__50180 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__50180.cljs$core$IFn$_invoke$arity$1 ? fexpr__50180.cljs$core$IFn$_invoke$arity$1(G__50181) : fexpr__50180.call(null,G__50181));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50177,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50177,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__50175_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__50175_SHARP_))){
return p1__50175_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__50176_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__50176_SHARP_));
...
var tag = first__50198;
var content = seq__50197__$1;
...
var vec__50199 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50199,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50199,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50199,(2),null);
