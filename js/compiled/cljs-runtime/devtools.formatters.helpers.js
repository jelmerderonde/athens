...
var G__41118 = devtools.prefs.pref(v);
v = G__41118;
continue;
} else {
return v;
...
}catch (e41075){var _e__40458__auto__ = e41075;
return false;
}})();
...
}catch (e41079){var _e__40458__auto__ = e41079;
return false;
}})();
...
}catch (e41082){var _e__40458__auto__ = e41082;
return false;
}}
}
});
...
var vec__41097 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41097,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41097,(1),null);
...
return cljs.core.some((function (p1__41103_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41103_SHARP_);
}),template);
});
