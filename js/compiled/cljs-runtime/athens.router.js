...
var G__51230_51340 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__51231_51341 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__51230_51340,G__51231_51341) : re_frame.core.reg_sub.call(null,G__51230_51340,G__51231_51341));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__51237){
var vec__51238 = p__51237;
var seq__51239 = cljs.core.seq(vec__51238);
var first__51240 = cljs.core.first(seq__51239);
var seq__51239__$1 = cljs.core.next(seq__51239);
var ___$1 = first__51240;
var route = seq__51239__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__51241,p__51242){
var map__51243 = p__51241;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51243__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__51244 = p__51242;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51244,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51244,(1),null);
...
var node = (function (){var G__51254 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"node","node",581201198),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null)], null);
...
var G__51282_51364 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__51283_51365 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__47115__auto__;
}catch (e51311){var e = e51311;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__51282_51364,G__51283_51365) : re_frame.core.reg_fx.call(null,G__51282_51364,G__51283_51365));
...
var G__51324 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__51324) : re_frame.core.dispatch.call(null,G__51324));
} else {
return null;
}
});
athens.router.navigate_page = (function athens$router$navigate_page(uid){
var G__51331 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__51331) : re_frame.core.dispatch.call(null,G__51331));
});
athens.router.toggle_open = (function athens$router$toggle_open(dbid,open){
var G__51333 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","toggle-open","block/toggle-open",2080151710),dbid,open], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__51333) : re_frame.core.dispatch.call(null,G__51333));
});
