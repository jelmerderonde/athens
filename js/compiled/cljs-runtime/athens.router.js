...
var G__49070_49162 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__49071_49163 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__49070_49162,G__49071_49163) : re_frame.core.reg_sub.call(null,G__49070_49162,G__49071_49163));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__49084){
var vec__49085 = p__49084;
var seq__49086 = cljs.core.seq(vec__49085);
var first__49087 = cljs.core.first(seq__49086);
var seq__49086__$1 = cljs.core.next(seq__49086);
var ___$1 = first__49087;
var route = seq__49086__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__49092,p__49093){
var map__49094 = p__49092;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49094__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__49095 = p__49093;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49095,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49095,(1),null);
...
var node = (function (){var G__49120 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"node","node",581201198),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__49120) : re_frame.core.subscribe.call(null,G__49120));
})();
...
var G__49124_49165 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__49125_49166 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
var result__47122__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__47121__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__47122__auto__ = reitit.frontend.easy.push_state;
...
var result__47122__auto__ = route;
...
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__49124_49165,G__49125_49166) : re_frame.core.reg_fx.call(null,G__49124_49165,G__49125_49166));
...
var G__49129 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49129) : re_frame.core.dispatch.call(null,G__49129));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__49131 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49131) : re_frame.core.dispatch.call(null,G__49131));
});
athens.router.navigate_page = (function athens$router$navigate_page(uid){
var G__49154 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49154) : re_frame.core.dispatch.call(null,G__49154));
});
athens.router.toggle_open = (function athens$router$toggle_open(dbid,open){
var G__49161 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","toggle-open","block/toggle-open",2080151710),dbid,open], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49161) : re_frame.core.dispatch.call(null,G__49161));
});
