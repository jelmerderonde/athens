...
var G__48950_48984 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__48951_48985 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__48950_48984,G__48951_48985) : re_frame.core.reg_sub.call(null,G__48950_48984,G__48951_48985));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__48957){
var vec__48962 = p__48957;
...
var ___$1 = first__48964;
var route = seq__48963__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__48965,p__48966){
var map__48968 = p__48965;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48968__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__48969 = p__48966;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48969,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48969,(1),null);
...
var node = (function (){var G__48973 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"node","node",581201198),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__48973) : re_frame.core.subscribe.call(null,G__48973));
})();
...
var G__48974_49006 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__48975_49007 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__47122__auto__;
}catch (e48976){var e = e48976;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__48974_49006,G__48975_49007) : re_frame.core.reg_fx.call(null,G__48974_49006,G__48975_49007));
...
var G__48978 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48978) : re_frame.core.dispatch.call(null,G__48978));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__48979 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48979) : re_frame.core.dispatch.call(null,G__48979));
});
athens.router.navigate_page = (function athens$router$navigate_page(uid){
var G__48980 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48980) : re_frame.core.dispatch.call(null,G__48980));
});
athens.router.toggle_open = (function athens$router$toggle_open(dbid,open){
var G__48981 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","toggle-open","block/toggle-open",2080151710),dbid,open], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__48981) : re_frame.core.dispatch.call(null,G__48981));
});
