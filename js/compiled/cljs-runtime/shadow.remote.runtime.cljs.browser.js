...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68010,action,ex){
...
var state = map__68011__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68011__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__68013 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68013) : callback.call(null,G__68013));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__68014,p__68015){
...
var action = map__68017__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68017__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__68020 = type;
var G__68020__$1 = (((G__68020 instanceof cljs.core.Keyword))?G__68020.fqn:null);
switch (G__68020__$1) {
case "repl/invoke":
var map__68021 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68021__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__68024 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__68024) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__68024));
}catch (e68023){var ex = e68023;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68020__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__68025){
...
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68026__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__68028 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__68028.cljs$core$IFn$_invoke$arity$1 ? fexpr__68028.cljs$core$IFn$_invoke$arity$1(state) : fexpr__68028.call(null,state));
} else {
var map__68029 = cljs.core.first(actions);
...
var action = map__68029__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68029__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__68036 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__68037 = (function (res){
var req = this;
var map__68041 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__68041__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68041__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__68043 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68043) : callback.call(null,G__68043));
} else {
...
var G__68038 = "POST";
var G__68039 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__68040 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__68036,G__68037,G__68038,G__68039,G__68040);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68032,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68032,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__68045){
var vec__68046 = p__68045;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68046,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68046,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__68031){
var self__ = this;
var G__68031__$1 = this;
return (new cljs.core.RecordIter((0),G__68031__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__68049 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68049(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68033,other68034){
var self__ = this;
var this68033__$1 = this;
return (((!((other68034 == null)))) && ((this68033__$1.constructor === other68034.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68033__$1.ws,other68034.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68033__$1.state_ref,other68034.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68033__$1.__extmap,other68034.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68031){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68050 = cljs.core.keyword_identical_QMARK_;
var expr__68051 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68053 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__68054 = expr__68051;
return (pred__68050.cljs$core$IFn$_invoke$arity$2 ? pred__68050.cljs$core$IFn$_invoke$arity$2(G__68053,G__68054) : pred__68050.call(null,G__68053,G__68054));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__68031,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68055 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68056 = expr__68051;
return (pred__68050.cljs$core$IFn$_invoke$arity$2 ? pred__68050.cljs$core$IFn$_invoke$arity$2(G__68055,G__68056) : pred__68050.call(null,G__68055,G__68056));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__68031,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68031),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68031){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__68031,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__68035){
var extmap__4478__auto__ = (function (){var G__68057 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68035,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
...
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__68035),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__68035),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__68058 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68058);
...
var map__68059 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68059__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
